...
class _AuthenticationPageState extends State<AuthenticationPage> {
  ...
  void initState() {
    super.initState();
    firebaseController.loading.value = false;
  }
              ...
              InkWell(
                onTap: () async {
                  if (!isLoginScreen) {
                    ...
                    try {
                      var resultas = firebaseController.registerUser(
                          registerController.usernameController.text,
                          registerController.emailController.text,
                          registerController.passwordController.text);
                    ...
                    registerController.usernameController?.text = 'abcdef';
                    registerController.emailController.text = 'abc@gmail.com';
                    ...
                    try {
                      var resulta = firebaseController.signInWithEmailPassword(
                          registerController.emailController.text,
                          registerController.passwordController.text);
                      ...
                      if (result == Constants.loginOk) {
                        ...
                        //if (result == Constants.loginOk) {
                        menuController
                            .changeActiveItemTo(AppRoutes.recordDisplayName);
                ...
                child: Container(
                  ...
                  child: isRegistering || firebaseController.isLoading()
